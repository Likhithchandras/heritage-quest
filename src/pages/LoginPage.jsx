...
import { User, Mail, Lock, Eye, EyeOff, Sparkles, ArrowRight, CheckCircle2, Shield, Palette, Globe } from 'lucide-react';
...
export default function LoginPage() {
  ...
  const handleSubmit = (e) => {
    ...
    if (isSignUp) {
      ...
      setSuccessMessage(`Account created for ${user.name}! Starting expedition...`);
      ...
      setExplorerName(user.name);
      setSuccessMessage(`Welcome back, ${user.name}! Loading expedition...`);
      soundEffects.playSuccess();
  ...
  const themeGradients = {
    'lapis-gold': {
      bgGlow: 'from-blue-950/50 via-stone-950 to-amber-950/40',
    ...
    'patina-bronze': {
      bgGlow: 'from-emerald-950/50 via-stone-950 to-stone-900',
    ...
    'forest-brass': {
      bgGlow: 'from-emerald-950/50 via-stone-950 to-amber-950/40',
      cardBorder: 'border-emerald-500/40',
      ...
      <div className={`w-full max-w-5xl rounded-[32px] border-2 ${activeThemeStyle.cardBorder} bg-stone-950/90 backdrop-blur-xl shadow-[0_0_50px_rgba(0,0,0,0.8)] overflow-hidden grid grid-cols-1 lg:grid-cols-12 transition-all duration-500`}>
        ...
        <div className="lg:col-span-7 p-6 sm:p-10 flex flex-col justify-between space-y-6 border-b lg:border-b-0 lg:border-r border-white/10 relative">
          ...
          <div className="space-y-4">
            {/* Top Badge & Language/Theme Selectors */}
          ...
          <div className="flex items-center space-x-4 p-4 rounded-2xl bg-gradient-to-r from-stone-900/90 to-stone-950/90 border border-amber-500/30 shadow-lg">
            <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full border-2 border-amber-400/60 p-1 shadow-inner flex-shrink-0 bg-stone-900">
              <img
